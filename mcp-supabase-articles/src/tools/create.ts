import { getSupabase, Article } from '../supabase.js';
...
export async function createArticle(params: Record<string, unknown>): Promise<{ content: { type: 'text'; text: string }[] }> {
  // Validate
  ...
  const article: Partial<Article> = {
    ...
    audience: params.audience as 'consumer' | 'practice',
    category: params.category as string,
    sections: params.sections as Article['sections'],
    tags: params.tags as string[] | undefined,
    is_pillar: params.is_pillar as boolean | undefined,
    pillar_slug: params.pillar_slug as string | undefined,
    related_slugs: params.related_slugs as string[] | undefined,
    meta_title: params.meta_title as string | undefined,
    meta_description: params.meta_description as string | undefined,
    featured_image_url: params.featured_image_url as string | undefined,
    cta_type: params.cta_type as Article['cta_type'],
    cta_href: params.cta_href as string | undefined,
    cta_label: params.cta_label as string | undefined,
    status: 'draft'
  };
